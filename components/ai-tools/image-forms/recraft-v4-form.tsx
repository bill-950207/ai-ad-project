...
import { RECRAFT_V4_CREDIT_COST } from '@/lib/credits/constants'
import { useLanguage } from '@/contexts/language-context'

const ASPECT_RATIOS = ['1:1', '4:3', '3:4', '16:9', '9:16'] as const

interface RecraftV4FormProps {
  onSubmit: (data: {
    model: 'recraft-v4'
    prompt: string
...
export default function RecraftV4Form({ onSubmit, isGenerating }: RecraftV4FormProps) {
  const { t } = useLanguage()
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      >
        ...
        {isGenerating
          ...
          : `${aiToolsT.generate || '생성하기'} (${RECRAFT_V4_CREDIT_COST} ${aiToolsT.credits || '크레딧'})`
        }
      </button>
    </form>
  )
