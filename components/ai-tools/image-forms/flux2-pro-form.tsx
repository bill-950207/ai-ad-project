...
export default function Flux2ProForm({ onSubmit, isGenerating }: Flux2ProFormProps) {
  const { t } = useLanguage()
...
export { ASPECT_RATIO_SIZES as FLUX2_ASPECT_RATIO_SIZES }
