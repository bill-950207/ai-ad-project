...
import { WAN26_CREDIT_PER_SECOND } from '@/lib/credits/constants'
...
export default function Wan26Form({ onSubmit, isGenerating }: Wan26FormProps) {
  const { t } = useLanguage()
  ...
  const estimatedCredits = useMemo(() => {
    return WAN26_CREDIT_PER_SECOND[resolution] * duration
  }, [resolution, duration])
