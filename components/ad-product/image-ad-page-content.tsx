      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold mb-2">
            <span className="gradient-brand-text">{t.imageAd?.title || '이미지 광고'}</span>
          </h1>
          <p className="text-muted-foreground text-lg">{t.imageAd?.subtitle || '이미지 광고를 생성하고 관리하세요'}</p>
        </div>
        <button
        ...
        {isAdsLoading ? (
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-card to-accent/10 border border-border rounded-2xl p-16 text-center">
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground mb-8">{'이미지 광고를 생성해보세요'}</p>
              <button
                onClick={handleCreateAd}
