...
| **제품 등록** | 1 | - | 배경 제거 포함 |
| **의상 교체** | 2 | Kie.ai Seedream 4.5 | ~$0.05 |
...
> Vidu Q2는 아바타 모션, 제품 광고 씬별 영상에서 사용됩니다.

### 5. 영상 생성 - 기타

| 기능 | 크레딧 | AI 모델 | 비고 |
|------|--------|---------|------|
| **아바타 모션 (5초)** | 40 | Kie.ai Kling 2.6 | ~$0.50 |
| **아바타 모션 (10초)** | 60 | Kie.ai Kling 2.6 | ~$0.80 |
...
Step 6: 영상 생성 (Kling 2.6 또는 Vidu Q2)
  └─ Kling: 40~60크레딧 (5초/10초)
  └─ Vidu: 1~3크레딧/초 (해상도별)
```
...
| 플랜 | 월간 크레딧 | 월 가격 | 연 가격 | 아바타 | 음악 | 제품 | 특별 기능 |
|------|------------|--------|--------|--------|------|------|----------|
| **FREE** | 15 | $0 | $0 | 3개 | 5개 | 3개 | - |
| **STARTER** | 50 | $9.99 | $99.90 | 9개 | 15개 | 9개 | HD 업스케일, 키프레임 2개 |
| **PRO** | 200 | $29.99 | $299.90 | 30개 | 50개 | 30개 | 워터마크 제거, HD 업스케일 |
| **BUSINESS** | 500 | $99.99 | $999.90 | 무제한 | 무제한 | 무제한 | 모든 프리미엄 기능 |
...
| `POST /api/avatar-motion/generate-video` | 40~60 | 5초/10초 |
| `POST /api/avatar-motion/generate-scene-video` | 1~3×초 | Vidu 해상도별 |
...
### FREE 플랜 사용자 (월 15 크레딧)

| 작업 | 크레딧 | 누적 소비 | 잔여 |
|------|--------|----------|------|
| 이미지 광고 2개 (Medium) | 4 | 4 | 11 |
| 의상 교체 3개 | 6 | 10 | 5 |
| 제품 등록 1개 | 1 | 11 | 4 |
| 음악 생성 4개 | 4 | 15 | 0 |

### PRO 플랜 사용자 (월 200 크레딧)

| 작업 | 크레딧 | 누적 소비 | 잔여 |
|------|--------|----------|------|
| 이미지 광고 10개 (High) | 30 | 30 | 170 |
| 제품 광고 5개 (Wan 10초) | 75 | 105 | 95 |
| 아바타 모션 1개 (5초) | 40 | 145 | 55 |
| 제품 설명 영상 5개 (720p) | 50 | 195 | 5 |
