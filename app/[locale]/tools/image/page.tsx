...
const i18n: Record<Locale, {
  ...
  ko: {
    ...
    faq: [
      ...
      { q: 'AI 이미지 생성 비용은 얼마인가요?', a: '회원가입 시 20크레딧이 무료로 제공됩니다. Seedream 5는 기본 화질 2크레딧, 고화질 3크레딧, Z-Image는 1크레딧, FLUX.2 Pro는 기본 1크레딧/고화질 2크레딧, Grok Imagine Image는 1크레딧입니다.' },
    ...
    bottomCtaDesc: '회원가입 시 20크레딧 무료 제공. 4종 AI 모델로 고품질 이미지를 생성하세요.',
  },
  en: {
    breadcrumbHome: 'Home',
    ...
    faq: [
      ...
      { q: 'How much does AI image generation cost?', a: 'You get 20 free credits on sign up. Seedream 5 costs 2–3 credits, Z-Image costs 1 credit, FLUX.2 Pro costs 1–2 credits, and Grok Imagine Image costs 1 credit per generation.' },
    ...
    bottomCtaDesc: '20 free credits on sign up. Create images with 4 AI models.',
  },
  ja: {
    breadcrumbHome: 'ホーム',
    badge: 'AI画像生成ツール',
    ...
    faq: [
      ...
      { q: 'AI画像生成の料金はいくらですか？', a: '会員登録時に20クレジットが無料で付与されます。Seedream 5は2〜3クレジット、Z-Imageは1クレジット、FLUX.2 Proは基本1クレジット/高画質2クレジット、Grok Imagine Imageは1クレジットです。' },
    ...
    bottomCtaDesc: '会員登録で20クレジット無料。4種AIモデルで高品質な画像を生成。',
  },
  zh: {
    breadcrumbHome: '首页',
    badge: 'AI图片生成工具',
    ...
    faq: [
      ...
      { q: 'AI图片生成费用是多少？', a: '注册时免费获得20积分。Seedream 5为2~3积分，Z-Image为1积分，FLUX.2 Pro为基础1积分/高画质2积分，Grok Imagine Image为1积分。' },
    ...
    pricingCta: '查看价格',
    bottomCta: '立即制作AI图片',
    bottomCtaDesc: '注册即送20免费积分。4种AI模型生成高质量图片。',
  },
}
