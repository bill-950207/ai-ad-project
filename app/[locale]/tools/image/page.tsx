...
const i18n: Record<Locale, {
  ...
  ko: {
    ...
    badge: 'AI 이미지 생성 도구',
    heading: 'AI 이미지 생성',
    subheading: 'ByteDance Seedream 5와 Z-Image로 고품질 AI 이미지를 생성하세요',
    intro: 'gwanggo의 AI 이미지 생성 도구는 ByteDance(바이트댄스)의 Seedream 5 모델과 Z-Image 모델을 지원합니다. Seedream 5는 참조 이미지를 기반으로 AI가 이미지를 편집하는 Image Edit 모델이며, Z-Image는 텍스트 프롬프트만으로 이미지를 생성하는 Text-to-Image 모델입니다. 다양한 화면 비율과 화질 옵션을 지원하며, 회원가입 시 무료 크레딧이 제공됩니다.',
    cta: '무료로 시작하기',
    modelsTitle: '지원 모델',
    models: [
      {
  ...
  en: {
    ...
    subheading: 'Create high-quality AI images with ByteDance Seedream 5 and Z-Image',
  ...
  ja: {
    ...
    badge: 'AI画像生成ツール',
    heading: 'AI画像生成',
    subheading: 'ByteDance Seedream 5とZ-Imageで高品質なAI画像を生成',
    intro: 'gwanggoのAI画像生成ツールは、ByteDance（バイトダンス）のSeedream 5モデルとZ-Imageモデルに対応しています。Seedream 5は参照画像をベースにAIが画像を編集するImage Editモデル、Z-Imageはテキストプロンプトのみで画像を生成するText-to-Imageモデルです。多様なアスペクト比と画質オプションに対応。会員登録時に無料クレジット付与。',
    cta: '無料で始める',
    modelsTitle: '対応モデル',
    models: [
      {
  ...
  zh: {
    ...
    badge: 'AI图片生成工具',
    heading: 'AI图片生成',
    subheading: '使用ByteDance Seedream 5和Z-Image生成高质量AI图片',
    intro: 'gwanggo的AI图片生成工具支持ByteDance（字节跳动）的Seedream 5模型和Z-Image模型。Seedream 5是基于参考图片进行AI编辑的Image Edit模型，Z-Image是仅通过文字提示生成图片的Text-to-Image模型。支持多种画面比例和画质选项。注册即送免费积分。',
    cta: '免费开始',
    modelsTitle: '支持模型',
    models: [
      {
