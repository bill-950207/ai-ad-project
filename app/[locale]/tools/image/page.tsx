...
const i18n: Record<Locale, {
  ...
  ko: {
    ...
    badge: 'AI 이미지 생성 도구',
    heading: 'AI 이미지 생성',
    subheading: 'ByteDance Seedream 4.5와 Z-Image로 고품질 AI 이미지를 생성하세요',
    intro: 'gwanggo의 AI 이미지 생성 도구는 ByteDance(바이트댄스)의 Seedream 4.5 모델과 Z-Image 모델을 지원합니다. Seedream 4.5는 참조 이미지를 기반으로 AI가 이미지를 편집하는 Image Edit 모델이며, Z-Image는 텍스트 프롬프트만으로 이미지를 생성하는 Text-to-Image 모델입니다. 다양한 화면 비율과 화질 옵션을 지원하며, 회원가입 시 무료 크레딧이 제공됩니다.',
    cta: '무료로 시작하기',
    modelsTitle: '지원 모델',
    models: [
      {
    ...
    steps: [
      ...
      { icon: 'upload', title: '이미지 업로드 (Seedream)', desc: 'Seedream 4.5 사용 시 참조 이미지를 업로드' },
    ...
    comparisonHeaders: ['항목', 'Seedream 4.5', 'Z-Image'],
    comparisonRows: [
    ...
    faqTitle: '자주 묻는 질문',
    faq: [
      { q: 'Seedream 4.5는 어떤 모델인가요?', a: 'Seedream 4.5는 ByteDance(바이트댄스)가 개발한 AI 이미지 편집 모델입니다. 참조 이미지를 업로드하고 텍스트 프롬프트로 편집 지시를 내리면, AI가 이미지를 원하는 스타일로 변환합니다. 1:1부터 21:9까지 8가지 화면 비율과 기본/고화질 옵션을 지원합니다.' },
      ...
      { q: 'Seedream 4.5와 Z-Image의 차이는 무엇인가요?', a: 'Seedream 4.5는 참조 이미지를 기반으로 편집하는 Image Edit 모델이고, Z-Image는 텍스트만으로 새 이미지를 생성하는 Text-to-Image 모델입니다. 기존 이미지를 수정하려면 Seedream 4.5를, 새 이미지를 만들려면 Z-Image를 선택하세요.' },
      { q: 'AI 이미지 생성 비용은 얼마인가요?', a: '회원가입 시 15크레딧이 무료로 제공됩니다. Seedream 4.5는 기본 화질 2크레딧, 고화질 3크레딧이며, Z-Image는 1크레딧입니다.' },
    ...
    bottomCtaDesc: '회원가입 시 15크레딧 무료 제공. Seedream 4.5와 Z-Image로 고품질 AI 이미지를 생성하세요.',
  },
  en: {
    breadcrumbHome: 'Home',
    badge: 'AI Image Generation Tool',
    heading: 'AI Image Generator',
    subheading: 'Create high-quality AI images with ByteDance Seedream 4.5 and Z-Image',
    intro: 'gwanggo\'s AI image generator supports ByteDance\'s Seedream 4.5 and Z-Image models. Seedream 4.5 is an Image Edit model that transforms images using reference photos and text prompts. Z-Image is a Text-to-Image model that generates images from text alone. Multiple aspect ratios and quality options available. Free credits on sign up.',
    cta: 'Start for Free',
    ...
    steps: [
      ...
      { icon: 'upload', title: 'Upload Image (Seedream)', desc: 'Upload a reference image for Seedream 4.5' },
    ...
    comparisonHeaders: ['Feature', 'Seedream 4.5', 'Z-Image'],
    comparisonRows: [
    ...
    faq: [
      ...
      { q: 'What is the difference between Seedream 4.5 and Z-Image?', a: 'Seedream 4.5 is an Image Edit model that modifies existing images based on a reference, while Z-Image is a Text-to-Image model that creates new images from text. Use Seedream 4.5 to modify existing images, Z-Image to create new ones.' },
      { q: 'How much does AI image generation cost?', a: 'You get 15 free credits on sign up. Seedream 4.5 costs 2 credits (basic) or 3 credits (high quality). Z-Image costs 1 credit per generation.' },
    ...
    bottomCtaDesc: '15 free credits on sign up. Generate high-quality AI images with Seedream 4.5 and Z-Image.',
  },
  ja: {
    breadcrumbHome: 'ホーム',
    badge: 'AI画像生成ツール',
    heading: 'AI画像生成',
    subheading: 'ByteDance Seedream 4.5とZ-Imageで高品質なAI画像を生成',
    intro: 'gwanggoのAI画像生成ツールは、ByteDance（バイトダンス）のSeedream 4.5モデルとZ-Imageモデルに対応しています。Seedream 4.5は参照画像をベースにAIが画像を編集するImage Editモデル、Z-Imageはテキストプロンプトのみで画像を生成するText-to-Imageモデルです。多様なアスペクト比と画質オプションに対応。会員登録時に無料クレジット付与。',
    cta: '無料で始める',
    modelsTitle: '対応モデル',
    models: [
      {
    ...
    steps: [
      ...
      { icon: 'upload', title: '画像アップロード（Seedream）', desc: 'Seedream 4.5使用時に参照画像をアップロード' },
    ...
    comparisonHeaders: ['項目', 'Seedream 4.5', 'Z-Image'],
    comparisonRows: [
    ...
    faqTitle: 'よくある質問',
    faq: [
      { q: 'Seedream 4.5とは何ですか？', a: 'Seedream 4.5はByteDance（バイトダンス）が開発したAI画像編集モデルです。参照画像をアップロードし、テキストプロンプトで編集指示を出すと、AIが画像を目的のスタイルに変換します。1:1から21:9まで8種類のアスペクト比と基本/高画質オプションに対応。' },
      { q: 'Z-Imageとは何ですか？', a: 'Z-ImageはText-to-Image AIモデルで、テキストプロンプトのみで高品質な画像を自動生成します。参照画像なしで使用でき、アイデアの視覚化、広告素材、ブログ画像などの制作に最適です。' },
      { q: 'Seedream 4.5とZ-Imageの違いは？', a: 'Seedream 4.5は参照画像をベースに編集するImage Editモデル、Z-Imageはテキストから新しい画像を生成するText-to-Imageモデルです。既存の画像を修正するにはSeedream 4.5を、新しい画像を作るにはZ-Imageを選んでください。' },
      { q: 'AI画像生成の料金はいくらですか？', a: '会員登録時に15クレジットが無料で付与されます。Seedream 4.5は基本画質2クレジット、高画質3クレジット。Z-Imageは1クレジットです。' },
    ...
    bottomCtaDesc: '会員登録で15クレジット無料。Seedream 4.5とZ-Imageで高品質なAI画像を生成。',
  },
  zh: {
    breadcrumbHome: '首页',
    badge: 'AI图片生成工具',
    heading: 'AI图片生成',
    subheading: '使用ByteDance Seedream 4.5和Z-Image生成高质量AI图片',
    intro: 'gwanggo的AI图片生成工具支持ByteDance（字节跳动）的Seedream 4.5模型和Z-Image模型。Seedream 4.5是基于参考图片进行AI编辑的Image Edit模型，Z-Image是仅通过文字提示生成图片的Text-to-Image模型。支持多种画面比例和画质选项。注册即送免费积分。',
    cta: '免费开始',
    modelsTitle: '支持模型',
    models: [
      {
    ...
    steps: [
      ...
      { icon: 'upload', title: '上传图片（Seedream）', desc: '使用Seedream 4.5时上传参考图片' },
    ...
    comparisonHeaders: ['项目', 'Seedream 4.5', 'Z-Image'],
    comparisonRows: [
    ...
    faqTitle: '常见问题',
    faq: [
      { q: 'Seedream 4.5是什么模型？', a: 'Seedream 4.5是ByteDance（字节跳动）开发的AI图片编辑模型。上传参考图片并通过文字提示进行编辑，AI将图片按您想要的风格进行变换。支持从1:1到21:9的8种画面比例和基础/高画质选项。' },
      { q: 'Z-Image是什么模型？', a: 'Z-Image是Text-to-Image AI模型，仅输入文字提示即可自动生成高质量图片。无需参考图片，非常适合快速将想法可视化、制作广告素材或博客图片。' },
      { q: 'Seedream 4.5和Z-Image有什么区别？', a: 'Seedream 4.5是基于参考图片进行编辑的Image Edit模型，Z-Image是从文字生成新图片的Text-to-Image模型。要修改现有图片用Seedream 4.5，要创建新图片用Z-Image。' },
      { q: 'AI图片生成费用是多少？', a: '注册时免费获得15积分。Seedream 4.5基础画质2积分、高画质3积分，Z-Image每次1积分。' },
    ...
    pricingCta: '查看价格',
    bottomCta: '立即制作AI图片',
    bottomCtaDesc: '注册即送15免费积分。使用Seedream 4.5和Z-Image生成高质量AI图片。',
  },
}
