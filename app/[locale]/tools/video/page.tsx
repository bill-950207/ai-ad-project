...
const i18n: Record<Locale, {
  ...
  ko: {
    ...
    badge: 'AI 영상 생성 도구',
    heading: 'AI 영상 생성',
    subheading: 'ByteDance Seedance 1.5 Pro와 Vidu Q3로 텍스트·이미지에서 고품질 AI 영상을 만드세요',
    intro: 'gwanggo의 AI 영상 생성 도구는 ByteDance(바이트댄스)의 Seedance 1.5 Pro와 Shengshu Technology(生数科技)의 Vidu Q3 모델을 지원합니다. 텍스트 프롬프트만으로 영상을 생성하거나, 참조 이미지를 활용하여 더 정밀한 AI 동영상을 만들 수 있습니다. 480p부터 1080p까지 다양한 해상도와 최대 16초 길이의 영상을 지원하며, 회원가입 시 무료 크레딧이 제공됩니다.',
    cta: '무료로 시작하기',
    modelsTitle: '지원 모델',
    models: [
      {
    ...
    otherToolDesc: 'ByteDance Seedream 4.5와 Z-Image로 고품질 AI 이미지를 생성할 수 있습니다.',
  ...
  en: {
    ...
    subheading: 'Create high-quality AI videos from text and images with ByteDance Seedance 1.5 Pro and Vidu Q3',
    intro: 'gwanggo\'s AI video generator supports ByteDance\'s Seedance 1.5 Pro and Shengshu Technology\'s Vidu Q3 models. Generate videos from text prompts alone, or use reference images for more precise AI video creation. Supports resolutions from 480p to 1080p and up to 16 seconds in length. Free credits included on sign up.',
    cta: 'Start for Free',
    ...
    otherToolDesc: 'Create high-quality AI images with ByteDance Seedream 4.5 and Z-Image.',
  ...
  ja: {
    ...
    badge: 'AI動画生成ツール',
    heading: 'AI動画生成',
    subheading: 'ByteDance Seedance 1.5 ProとVidu Q3でテキスト・画像から高品質なAI動画を作成',
    intro: 'gwanggoのAI動画生成ツールは、ByteDance（バイトダンス）のSeedance 1.5 ProとShengshu Technology（生数科技）のVidu Q3モデルに対応しています。テキストプロンプトだけで動画を生成したり、参照画像を活用してより精密なAI動画を作成できます。480pから1080pまでの解像度と最大16秒の動画に対応。会員登録時に無料クレジット付与。',
    cta: '無料で始める',
    modelsTitle: '対応モデル',
    models: [
      {
    ...
    otherToolDesc: 'ByteDance Seedream 4.5とZ-Imageで高品質なAI画像を生成できます。',
  ...
  zh: {
    ...
    badge: 'AI视频生成工具',
    heading: 'AI视频生成',
    subheading: '使用ByteDance Seedance 1.5 Pro和Vidu Q3从文字和图片生成高质量AI视频',
    intro: 'gwanggo的AI视频生成工具支持ByteDance（字节跳动）的Seedance 1.5 Pro和Shengshu Technology（生数科技）的Vidu Q3模型。仅通过文字提示即可生成视频，也可以结合参考图片制作更精确的AI视频。支持480p到1080p多种分辨率，最长16秒。注册即送免费积分。',
    cta: '免费开始',
    modelsTitle: '支持模型',
    models: [
      {
    ...
    otherToolDesc: '使用ByteDance Seedream 4.5和Z-Image生成高质量AI图片。',
