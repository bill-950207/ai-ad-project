...
const i18n: Record<Locale, {
  ...
  ko: {
    ...
    badge: 'AI 영상 생성 도구',
    heading: 'AI 영상 생성',
    subheading: 'Seedance 1.5 Pro, Kling 3.0, Grok Imagine Video, Wan 2.6, Vidu Q3, Veo 3.1, Hailuo-02, LTX 2.3로 고품질 AI 영상 생성. Sora, Runway 대안.',
    intro: 'gwanggo의 AI 영상 생성 도구는 ByteDance(바이트댄스)의 Seedance 1.5 Pro, Shengshu Technology(生数科技)의 Vidu Q3 모델을 지원합니다. Kling 3.0(쿠아이쇼우/快手)의 Standard·Pro 등급, xAI의 Grok Imagine Video, 알리바바의 Wan 2.6, Google의 Veo 3.1, MiniMax의 Hailuo-02, Lightricks의 LTX 2.3 모델도 지원합니다. OpenAI Sora, Runway Gen-4, Pika, Luma Dream Machine 등 주요 AI 영상 모델의 대안으로, 광고 영상 제작에 특화되어 있습니다. 텍스트 프롬프트만으로 영상을 생성하거나, 참조 이미지를 활용하여 더 정밀한 AI 동영상을 만들 수 있습니다. 480p부터 1080p까지 다양한 해상도와 최대 20초 길이의 영상을 지원합니다.',
    cta: '무료로 시작하기',
    modelsTitle: '지원 모델',
    models: [
      {
      ...
      },
      {
        name: 'Veo 3.1',
        badge: 'Google',
        desc: 'Google이 개발한 Veo 3.1 AI 영상 생성 모델입니다. 텍스트만으로 또는 이미지와 함께 최대 1080p, 8초 길이의 영상을 생성할 수 있으며, 오디오 생성 기능도 지원합니다.',
        features: ['텍스트 → 영상 (Text to Video)', '이미지 → 영상 (Image to Video)', '최대 1080p Full HD', '오디오 포함 생성 지원'],
        specs: '해상도: 720p, 1080p | 길이: 1~8초 | 720p: 4크레딧/초, 1080p: 7크레딧/초',
      },
      {
        name: 'Hailuo-02',
        badge: 'MiniMax',
        desc: 'MiniMax(미니맥스)가 개발한 Hailuo-02 AI 영상 생성 모델입니다. Standard(768p)와 Pro(1080p) 두 가지 티어를 지원하며, 텍스트만으로 또는 이미지와 함께 최대 6초 길이의 영상을 생성합니다.',
        features: ['텍스트 → 영상 (Text to Video)', '이미지 → 영상 (Image to Video)', 'Standard (768p) / Pro (1080p)', '최대 6초 지원'],
        specs: '해상도: 768p(Standard), 1080p(Pro) | 길이: 1~6초 | Standard: 2크레딧/초, Pro: 3크레딧/초',
      },
      {
        name: 'LTX 2.3',
        badge: 'Lightricks',
        desc: 'Lightricks(라이트릭스)가 개발한 오픈소스 AI 영상 생성 모델 LTX-2.3입니다. 텍스트만으로 또는 이미지와 함께 최대 1080p, 20초 길이의 긴 영상을 생성할 수 있습니다.',
        features: ['텍스트 → 영상 (Text to Video)', '이미지 → 영상 (Image to Video)', '최대 1080p Full HD', '최대 20초 긴 영상 지원'],
        specs: '해상도: 720p, 1080p | 길이: 1~20초 | 720p: 4크레딧/초, 1080p: 5크레딧/초',
      },
    ],
    ...
    comparisonHeaders: ['항목', 'Seedance 1.5 Pro', 'Vidu Q3', 'Kling 3.0', 'Grok Video', 'Wan 2.6', 'Veo 3.1', 'Hailuo-02', 'LTX 2.3'],
    comparisonRows: [
      ['개발사', 'ByteDance', 'Shengshu', 'Kuaishou (快手)', 'xAI', 'Alibaba', 'Google', 'MiniMax', 'Lightricks'],
      ['입력 방식', '텍스트 / 이미지', '이미지 (필수)', '텍스트 / 이미지', '텍스트 / 이미지', '텍스트 / 이미지', '텍스트 / 이미지', '텍스트 / 이미지', '텍스트 / 이미지'],
      ['해상도', '480p, 720p', '540p~1080p', '720p', '480p, 720p', '720p, 1080p', '720p, 1080p', '768p, 1080p', '720p, 1080p'],
      ['영상 길이', '4~12초', '1~16초', '5초, 10초', '1~15초', '5~15초', '1~8초', '1~6초', '1~20초'],
      ['비용(크레딧/초)', '1~2', '1~3', '6(Std), 8(Pro)', '2~3', '4~5', '4~7', '2(Std), 3(Pro)', '4~5'],
    ],
    faqTitle: '자주 묻는 질문',
    faq: [
      ...
      { q: 'AI 영상 생성 비용은 얼마인가요?', a: '회원가입 시 20크레딧이 무료로 제공됩니다. Seedance 1.5 Pro는 480p: 1크레딧/초, 720p: 2크레딧/초, Vidu Q3는 540p: 1크레딧/초, 720p: 2크레딧/초, 1080p: 3크레딧/초, Kling 3.0은 Standard: 6크레딧/초, Pro: 8크레딧/초, Grok Video는 480p: 2크레딧/초, 720p: 3크레딧/초, Wan 2.6은 720p: 4크레딧/초, 1080p: 5크레딧/초, Veo 3.1은 720p: 4크레딧/초, 1080p: 7크레딧/초, Hailuo-02는 Standard: 2크레딧/초, Pro: 3크레딧/초, LTX 2.3은 720p: 4크레딧/초, 1080p: 5크레딧/초입니다.' },
      { q: '생성된 영상의 저작권은 누구에게 있나요?', a: 'gwanggo에서 생성한 모든 AI 영상의 사용 권리는 사용자에게 있습니다. 상업적 용도(광고, SNS, 쇼핑몰 등)로 자유롭게 사용하실 수 있습니다.' },
      { q: 'Text-to-Video와 Image-to-Video의 차이는 무엇인가요?', a: 'Text-to-Video는 텍스트 설명만으로 영상을 생성하는 방식이고, Image-to-Video는 참조 이미지를 기반으로 영상을 만드는 방식입니다. Image-to-Video는 원하는 시각적 스타일을 더 정확하게 반영할 수 있습니다. Seedance 1.5 Pro, Kling 3.0, Grok Imagine Video, Wan 2.6, Veo 3.1, Hailuo-02, LTX 2.3은 두 방식 모두 지원하고, Vidu Q3는 Image-to-Video 전용입니다.' },
      { q: 'Sora, Runway와 비교하면 어떤가요?', a: 'gwanggo는 Seedance 1.5 Pro, Kling 3.0, Grok Imagine Video, Wan 2.6, Vidu Q3, Veo 3.1, Hailuo-02, LTX 2.3 등 8종의 AI 영상 모델을 지원합니다. OpenAI Sora, Runway Gen-4, Pika, Luma Dream Machine 등과 비교해 광고 영상 제작에 특화되어 있습니다. 별도 앱 설치 없이 웹에서 바로 사용할 수 있습니다.' },
      ...
      { q: 'Veo 3.1은 어떤 모델인가요?', a: 'Veo 3.1은 Google이 개발한 AI 영상 생성 모델입니다. 텍스트만으로 또는 이미지와 함께 최대 1080p, 8초 길이의 영상을 생성할 수 있으며, 오디오 생성 기능도 지원합니다. 720p는 4크레딧/초, 1080p는 7크레딧/초입니다.' },
      { q: 'Hailuo-02는 어떤 모델인가요?', a: 'Hailuo-02는 MiniMax(미니맥스)가 개발한 AI 영상 생성 모델입니다. Standard(768p)와 Pro(1080p) 두 가지 티어를 지원하며, 텍스트만으로 또는 이미지와 함께 최대 6초 길이의 영상을 생성합니다. Standard는 2크레딧/초, Pro는 3크레딧/초입니다.' },
      { q: 'LTX 2.3은 어떤 모델인가요?', a: 'LTX 2.3은 Lightricks(라이트릭스)가 개발한 오픈소스 AI 영상 생성 모델입니다. 텍스트만으로 또는 이미지와 함께 최대 1080p, 20초 길이의 긴 영상을 생성할 수 있습니다. 720p는 4크레딧/초, 1080p는 5크레딧/초입니다.' },
    ],
    ...
    bottomCtaDesc: '회원가입 시 20크레딧 무료 제공. 8종 AI 모델로 고품질 영상을 생성하세요.',
  },
  en: {
    breadcrumbHome: 'Home',
    badge: 'AI Video Generation Tool',
    heading: 'AI Video Generator',
    subheading: 'Generate AI videos with Seedance 1.5 Pro, Kling 3.0, Grok Video, Wan 2.6, Vidu Q3, Veo 3.1, Hailuo-02 & LTX 2.3. Best Sora & Runway alternative.',
    intro: 'gwanggo\'s AI video generator supports 8 models: ByteDance\'s Seedance 1.5 Pro, Shengshu Technology\'s Vidu Q3, Kuaishou\'s Kling 3.0 (Standard & Pro tiers), xAI\'s Grok Imagine Video, Alibaba\'s Wan 2.6, Google\'s Veo 3.1, MiniMax\'s Hailuo-02, and Lightricks\' LTX 2.3. A powerful alternative to OpenAI Sora, Runway Gen-4, Pika, and Luma Dream Machine, optimized for commercial ad video creation. Generate videos from text prompts alone, or use reference images for more precise AI video creation. Supports resolutions from 480p to 1080p and up to 20 seconds.',
    cta: 'Start for Free',
    ...
    models: [
      ...
      },
      {
        name: 'Veo 3.1',
        badge: 'Google',
        desc: 'Veo 3.1 AI video generation model by Google. Generate videos up to 1080p and 8 seconds from text alone or with a reference image. Also supports audio generation.',
        features: ['Text → Video (Text to Video)', 'Image → Video (Image to Video)', 'Up to 1080p Full HD', 'Audio generation supported'],
        specs: 'Resolution: 720p, 1080p | Duration: 1–8s | 720p: 4 credits/sec, 1080p: 7 credits/sec',
      },
      {
        name: 'Hailuo-02',
        badge: 'MiniMax',
        desc: 'Hailuo-02 AI video generation model by MiniMax. Supports Standard (768p) and Pro (1080p) tiers, generating videos up to 6 seconds from text alone or with a reference image.',
        features: ['Text → Video (Text to Video)', 'Image → Video (Image to Video)', 'Standard (768p) / Pro (1080p)', 'Up to 6 seconds'],
        specs: 'Resolution: 768p (Standard), 1080p (Pro) | Duration: 1–6s | Standard: 2 credits/sec, Pro: 3 credits/sec',
      },
      {
        name: 'LTX 2.3',
        badge: 'Lightricks',
        desc: 'LTX 2.3 open-source AI video generation model by Lightricks. Generate videos up to 1080p and 20 seconds from text alone or with a reference image.',
        features: ['Text → Video (Text to Video)', 'Image → Video (Image to Video)', 'Up to 1080p Full HD', 'Up to 20 seconds long video'],
        specs: 'Resolution: 720p, 1080p | Duration: 1–20s | 720p: 4 credits/sec, 1080p: 5 credits/sec',
      },
    ],
    ...
    comparisonHeaders: ['Feature', 'Seedance 1.5 Pro', 'Vidu Q3', 'Kling 3.0', 'Grok Video', 'Wan 2.6', 'Veo 3.1', 'Hailuo-02', 'LTX 2.3'],
    comparisonRows: [
      ['Developer', 'ByteDance', 'Shengshu', 'Kuaishou', 'xAI', 'Alibaba', 'Google', 'MiniMax', 'Lightricks'],
      ['Input', 'Text / Image', 'Image (required)', 'Text / Image', 'Text / Image', 'Text / Image', 'Text / Image', 'Text / Image', 'Text / Image'],
      ['Resolution', '480p, 720p', '540p–1080p', '720p', '480p, 720p', '720p, 1080p', '720p, 1080p', '768p, 1080p', '720p, 1080p'],
      ['Duration', '4–12s', '1–16s', '5s, 10s', '1–15s', '5–15s', '1–8s', '1–6s', '1–20s'],
      ['Cost (credits/sec)', '1–2', '1–3', '6(Std), 8(Pro)', '2–3', '4–5', '4–7', '2(Std), 3(Pro)', '4–5'],
    ],
    ...
    faq: [
      ...
      { q: 'How much does AI video generation cost?', a: 'You get 20 free credits on sign up. Seedance 1.5 Pro: 1 credit/sec at 480p, 2 at 720p. Vidu Q3: 1 credit/sec at 540p, 2 at 720p, 3 at 1080p. Kling 3.0: Standard 6 credits/sec, Pro 8 credits/sec. Grok Video: 2 credits/sec at 480p, 3 at 720p. Wan 2.6: 4 credits/sec at 720p, 5 at 1080p. Veo 3.1: 4 credits/sec at 720p, 7 at 1080p. Hailuo-02: Standard 2 credits/sec, Pro 3 credits/sec. LTX 2.3: 4 credits/sec at 720p, 5 at 1080p.' },
      ...
      { q: 'What is the difference between Text-to-Video and Image-to-Video?', a: 'Text-to-Video generates videos from text descriptions alone, while Image-to-Video creates videos based on a reference image. Image-to-Video allows more precise visual style control. Seedance 1.5 Pro, Kling 3.0, Grok Imagine Video, Wan 2.6, Veo 3.1, Hailuo-02, and LTX 2.3 support both, while Vidu Q3 is Image-to-Video only.' },
      { q: 'How does gwanggo compare to Sora, Runway, and other AI video tools?', a: 'gwanggo supports 8 AI video models: Seedance 1.5 Pro, Kling 3.0, Grok Imagine Video, Wan 2.6, Vidu Q3, Veo 3.1, Hailuo-02, and LTX 2.3. Compared to OpenAI Sora, Runway Gen-4, Pika, and Luma Dream Machine, gwanggo is optimized for ad video creation and works directly in the browser without any app installation.' },
      ...
      { q: 'What is Veo 3.1?', a: 'Veo 3.1 is an AI video generation model by Google. It generates videos up to 1080p and 8 seconds from text alone or with a reference image, and also supports audio generation. 720p costs 4 credits/sec, 1080p costs 7 credits/sec.' },
      { q: 'What is Hailuo-02?', a: 'Hailuo-02 is an AI video generation model by MiniMax. It supports Standard (768p) and Pro (1080p) tiers, generating videos up to 6 seconds from text alone or with a reference image. Standard costs 2 credits/sec, Pro costs 3 credits/sec.' },
      { q: 'What is LTX 2.3?', a: 'LTX 2.3 is an open-source AI video generation model by Lightricks. It generates videos up to 1080p and 20 seconds from text alone or with a reference image. 720p costs 4 credits/sec, 1080p costs 5 credits/sec.' },
    ],
    ...
    bottomCtaDesc: '20 free credits on sign up. Generate videos with 8 AI models.',
  },
  ja: {
    breadcrumbHome: 'ホーム',
    badge: 'AI動画生成ツール',
    heading: 'AI動画生成',
    subheading: 'Seedance 1.5 Pro、Kling 3.0、Grok Video、Wan 2.6、Vidu Q3、Veo 3.1、Hailuo-02、LTX 2.3で高品質AI動画を生成。Sora・Runway代替。',
    intro: 'gwanggoのAI動画生成ツールは、ByteDance（バイトダンス）のSeedance 1.5 Pro、Shengshu Technology（生数科技）のVidu Q3モデルに対応しています。Kling 3.0（Kuaishou/快手）のStandard・Proグレード、xAIのGrok Imagine Video、AlibabaのWan 2.6、GoogleのVeo 3.1、MiniMaxのHailuo-02、LightricksのLTX 2.3モデルにも対応。OpenAI Sora、Runway Gen-4、Pika、Luma Dream Machineの代替として、広告動画制作に特化しています。テキストプロンプトだけで動画を生成したり、参照画像を活用してより精密なAI動画を作成できます。480pから1080pまでの解像度と最大20秒の動画に対応。',
    cta: '無料で始める',
    modelsTitle: '対応モデル',
    models: [
      {
      ...
      },
      {
        name: 'Veo 3.1',
        badge: 'Google',
        desc: 'Googleが開発したVeo 3.1 AI動画生成モデル。テキストのみまたは画像と組み合わせて最大1080p、8秒の動画を生成でき、オーディオ生成機能も対応しています。',
        features: ['テキスト→動画（Text to Video）', '画像→動画（Image to Video）', '最大1080p Full HD', 'オーディオ付き生成対応'],
        specs: '解像度: 720p, 1080p | 長さ: 1〜8秒 | 720p: 4クレジット/秒, 1080p: 7クレジット/秒',
      },
      {
        name: 'Hailuo-02',
        badge: 'MiniMax',
        desc: 'MiniMax（ミニマックス）が開発したHailuo-02 AI動画生成モデル。Standard（768p）とPro（1080p）の2ティアに対応し、テキストのみまたは画像と組み合わせて最大6秒の動画を生成します。',
        features: ['テキスト→動画（Text to Video）', '画像→動画（Image to Video）', 'Standard（768p）/ Pro（1080p）', '最大6秒対応'],
        specs: '解像度: 768p(Standard), 1080p(Pro) | 長さ: 1〜6秒 | Standard: 2クレジット/秒, Pro: 3クレジット/秒',
      },
      {
        name: 'LTX 2.3',
        badge: 'Lightricks',
        desc: 'Lightricks（ライトリックス）が開発したオープンソースAI動画生成モデルLTX-2.3。テキストのみまたは画像と組み合わせて最大1080p、20秒の長い動画を生成できます。',
        features: ['テキスト→動画（Text to Video）', '画像→動画（Image to Video）', '最大1080p Full HD', '最大20秒の長い動画対応'],
        specs: '解像度: 720p, 1080p | 長さ: 1〜20秒 | 720p: 4クレジット/秒, 1080p: 5クレジット/秒',
      },
    ],
    howItWorksTitle: '使い方',
    steps: [
    ...
    comparisonHeaders: ['項目', 'Seedance 1.5 Pro', 'Vidu Q3', 'Kling 3.0', 'Grok Video', 'Wan 2.6', 'Veo 3.1', 'Hailuo-02', 'LTX 2.3'],
    comparisonRows: [
      ['開発元', 'ByteDance', 'Shengshu', 'Kuaishou（快手）', 'xAI', 'Alibaba', 'Google', 'MiniMax', 'Lightricks'],
      ['入力方式', 'テキスト / 画像', '画像（必須）', 'テキスト / 画像', 'テキスト / 画像', 'テキスト / 画像', 'テキスト / 画像', 'テキスト / 画像', 'テキスト / 画像'],
      ['解像度', '480p, 720p', '540p〜1080p', '720p', '480p, 720p', '720p, 1080p', '720p, 1080p', '768p, 1080p', '720p, 1080p'],
      ['動画長', '4〜12秒', '1〜16秒', '5秒, 10秒', '1〜15秒', '5〜15秒', '1〜8秒', '1〜6秒', '1〜20秒'],
      ['コスト（クレジット/秒）', '1〜2', '1〜3', '6(Std), 8(Pro)', '2〜3', '4〜5', '4〜7', '2(Std), 3(Pro)', '4〜5'],
    ],
    faqTitle: 'よくある質問',
    faq: [
      ...
      { q: 'AI動画生成の料金はいくらですか？', a: '会員登録時に20クレジットが無料で付与されます。Seedance 1.5 Pro: 480p 1クレジット/秒、720p 2クレジット/秒。Vidu Q3: 540p 1クレジット/秒、720p 2クレジット/秒、1080p 3クレジット/秒。Kling 3.0: Standard 6クレジット/秒、Pro 8クレジット/秒。Grok Video: 480p 2クレジット/秒、720p 3クレジット/秒。Wan 2.6: 720p 4クレジット/秒、1080p 5クレジット/秒。Veo 3.1: 720p 4クレジット/秒、1080p 7クレジット/秒。Hailuo-02: Standard 2クレジット/秒、Pro 3クレジット/秒。LTX 2.3: 720p 4クレジット/秒、1080p 5クレジット/秒。' },
      { q: '生成された動画の著作権は誰にありますか？', a: 'gwanggoで生成したすべてのAI動画の使用権はユーザーにあります。広告、SNS、ECサイトなど商業目的で自由にご使用いただけます。' },
      { q: 'Text-to-VideoとImage-to-Videoの違いは？', a: 'Text-to-Videoはテキスト説明のみで動画を生成する方式、Image-to-Videoは参照画像をベースに動画を作る方式です。Seedance 1.5 Pro、Kling 3.0、Grok Imagine Video、Wan 2.6、Veo 3.1、Hailuo-02、LTX 2.3は両方対応、Vidu Q3はImage-to-Video専用です。' },
      { q: 'Sora、Runwayなど他のAI動画ツールとの比較は？', a: 'gwanggoはSeedance 1.5 Pro、Kling 3.0、Grok Imagine Video、Wan 2.6、Vidu Q3、Veo 3.1、Hailuo-02、LTX 2.3の8種類のAI動画モデルに対応しています。OpenAI Sora、Runway Gen-4、Pika、Luma Dream Machineと比較して広告動画制作に特化しています。アプリ不要でブラウザから直接使用可能です。' },
      ...
      { q: 'Veo 3.1とは何ですか？', a: 'Veo 3.1はGoogleが開発したAI動画生成モデルです。テキストのみまたは画像と組み合わせて最大1080p、8秒の動画を生成でき、オーディオ生成機能にも対応しています。720pは4クレジット/秒、1080pは7クレジット/秒です。' },
      { q: 'Hailuo-02とは何ですか？', a: 'Hailuo-02はMiniMax（ミニマックス）が開発したAI動画生成モデルです。Standard（768p）とPro（1080p）の2ティアに対応し、テキストのみまたは画像と組み合わせて最大6秒の動画を生成します。Standardは2クレジット/秒、Proは3クレジット/秒です。' },
      { q: 'LTX 2.3とは何ですか？', a: 'LTX 2.3はLightricks（ライトリックス）が開発したオープンソースAI動画生成モデルです。テキストのみまたは画像と組み合わせて最大1080p、20秒の長い動画を生成できます。720pは4クレジット/秒、1080pは5クレジット/秒です。' },
    ],
    ...
    bottomCtaDesc: '会員登録で20クレジット無料。8種類のAIモデルで高品質な動画を生成。',
  },
  zh: {
    breadcrumbHome: '首页',
    badge: 'AI视频生成工具',
    heading: 'AI视频生成',
    subheading: '使用Seedance 1.5 Pro、Kling 3.0、Grok Video、Wan 2.6、Vidu Q3、Veo 3.1、Hailuo-02、LTX 2.3生成高质量AI视频。Sora、Runway替代方案。',
    intro: 'gwanggo的AI视频生成工具支持ByteDance（字节跳动）的Seedance 1.5 Pro、Shengshu Technology（生数科技）的Vidu Q3模型。同时支持Kling 3.0（快手）的Standard·Pro等级、xAI的Grok Imagine Video、阿里巴巴的Wan 2.6、Google的Veo 3.1、MiniMax的Hailuo-02、Lightricks的LTX 2.3模型。作为OpenAI Sora、Runway Gen-4、Pika、Luma Dream Machine的替代方案，专为广告视频制作优化。仅通过文字提示即可生成视频，也可以结合参考图片制作更精确的AI视频。支持480p到1080p多种分辨率，最长20秒。',
    cta: '免费开始',
    modelsTitle: '支持模型',
    models: [
      {
      ...
      },
      {
        name: 'Veo 3.1',
        badge: 'Google',
        desc: 'Google开发的Veo 3.1 AI视频生成模型。可以仅通过文字或结合图片生成最高1080p、8秒的视频，还支持音频生成功能。',
        features: ['文字→视频（Text to Video）', '图片→视频（Image to Video）', '最高1080p Full HD', '支持包含音频生成'],
        specs: '分辨率: 720p, 1080p | 时长: 1~8秒 | 720p: 4积分/秒, 1080p: 7积分/秒',
      },
      {
        name: 'Hailuo-02',
        badge: 'MiniMax',
        desc: 'MiniMax（MiniMax）开发的Hailuo-02 AI视频生成模型。支持Standard（768p）和Pro（1080p）两种等级，可以仅通过文字或结合图片生成最长6秒的视频。',
        features: ['文字→视频（Text to Video）', '图片→视频（Image to Video）', 'Standard（768p）/ Pro（1080p）', '最长6秒'],
        specs: '分辨率: 768p(Standard), 1080p(Pro) | 时长: 1~6秒 | Standard: 2积分/秒, Pro: 3积分/秒',
      },
      {
        name: 'LTX 2.3',
        badge: 'Lightricks',
        desc: 'Lightricks开发的开源AI视频生成模型LTX-2.3。可以仅通过文字或结合图片生成最高1080p、20秒的长视频。',
        features: ['文字→视频（Text to Video）', '图片→视频（Image to Video）', '最高1080p Full HD', '最长20秒长视频支持'],
        specs: '分辨率: 720p, 1080p | 时长: 1~20秒 | 720p: 4积分/秒, 1080p: 5积分/秒',
      },
    ],
    ...
    comparisonHeaders: ['项目', 'Seedance 1.5 Pro', 'Vidu Q3', 'Kling 3.0', 'Grok Video', 'Wan 2.6', 'Veo 3.1', 'Hailuo-02', 'LTX 2.3'],
    comparisonRows: [
      ['开发商', 'ByteDance', 'Shengshu', '快手（Kuaishou）', 'xAI', 'Alibaba', 'Google', 'MiniMax', 'Lightricks'],
      ['输入方式', '文字 / 图片', '图片（必须）', '文字 / 图片', '文字 / 图片', '文字 / 图片', '文字 / 图片', '文字 / 图片', '文字 / 图片'],
      ['分辨率', '480p, 720p', '540p~1080p', '720p', '480p, 720p', '720p, 1080p', '720p, 1080p', '768p, 1080p', '720p, 1080p'],
      ['视频时长', '4~12秒', '1~16秒', '5秒, 10秒', '1~15秒', '5~15秒', '1~8秒', '1~6秒', '1~20秒'],
      ['费用（积分/秒）', '1~2', '1~3', '6(Std), 8(Pro)', '2~3', '4~5', '4~7', '2(Std), 3(Pro)', '4~5'],
    ],
    faqTitle: '常见问题',
    faq: [
      ...
      { q: 'AI视频生成费用是多少？', a: '注册时免费获得20积分。Seedance 1.5 Pro: 480p 1积分/秒、720p 2积分/秒。Vidu Q3: 540p 1积分/秒、720p 2积分/秒、1080p 3积分/秒。Kling 3.0: Standard 6积分/秒、Pro 8积分/秒。Grok Video: 480p 2积分/秒、720p 3积分/秒。Wan 2.6: 720p 4积分/秒、1080p 5积分/秒。Veo 3.1: 720p 4积分/秒、1080p 7积分/秒。Hailuo-02: Standard 2积分/秒、Pro 3积分/秒。LTX 2.3: 720p 4积分/秒、1080p 5积分/秒。' },
      { q: '生成视频的版权归谁？', a: '在gwanggo上生成的所有AI视频的使用权归用户所有。可以自由用于广告、社交媒体、电商等商业目的。' },
      { q: 'Text-to-Video和Image-to-Video有什么区别？', a: 'Text-to-Video仅通过文字描述生成视频，Image-to-Video基于参考图片创建视频。Seedance 1.5 Pro、Kling 3.0、Grok Imagine Video、Wan 2.6、Veo 3.1、Hailuo-02、LTX 2.3两种方式都支持，Vidu Q3专用于Image-to-Video。' },
      { q: '与Sora、Runway等其他AI视频工具相比如何？', a: 'gwanggo支持Seedance 1.5 Pro、Kling 3.0、Grok Imagine Video、Wan 2.6、Vidu Q3、Veo 3.1、Hailuo-02、LTX 2.3等8种AI视频模型。与OpenAI Sora、Runway Gen-4、Pika、Luma Dream Machine相比，更专注于广告视频制作。无需安装应用程序即可在浏览器中直接使用。' },
      ...
      { q: 'Veo 3.1是什么模型？', a: 'Veo 3.1是Google开发的AI视频生成模型。可以仅通过文字或结合图片生成最高1080p、8秒的视频，还支持音频生成功能。720p为4积分/秒，1080p为7积分/秒。' },
      { q: 'Hailuo-02是什么模型？', a: 'Hailuo-02是MiniMax开发的AI视频生成模型。支持Standard（768p）和Pro（1080p）两种等级，可以仅通过文字或结合图片生成最长6秒的视频。Standard为2积分/秒，Pro为3积分/秒。' },
      { q: 'LTX 2.3是什么模型？', a: 'LTX 2.3是Lightricks开发的开源AI视频生成模型。可以仅通过文字或结合图片生成最高1080p、20秒的长视频。720p为4积分/秒，1080p为5积分/秒。' },
    ],
    ...
    pricingCta: '查看价格',
    bottomCta: '立即制作AI视频',
    bottomCtaDesc: '注册即送20免费积分。8种AI模型生成高质量视频。',
  },
}
            ...
            {t.models.map((model) => (
              <article key={model.name} className="rounded-2xl border border-border/80 bg-card p-6 sm:p-8">
                ...
                {modelSlugMap[model.name] && (
                  <Link
                    href={`/${locale}/tools/video/${modelSlugMap[model.name]}`}
