...
const i18n: Record<Lang, {
  ...
  ko: {
    ...
    h1: 'AI 이미지 생성',
    subtitle: 'Seedream 4.5와 Z-Image로 텍스트 또는 참조 이미지에서 고품질 이미지를 생성하세요.',
    breadcrumbHome: '홈',
    breadcrumbAiTools: 'AI 도구',
    breadcrumbImage: '이미지 생성',
    learnMore: '자세히 알아보기',
    faq: [
      { q: 'Seedream 4.5와 Z-Image의 차이점은 무엇인가요?', a: 'Seedream 4.5는 ByteDance가 개발한 이미지 편집 모델로 참조 이미지가 필요합니다. 기본/고화질 옵션과 다양한 비율을 지원합니다. Z-Image는 텍스트만으로 이미지를 생성하는 모델로, 참조 이미지 없이 프롬프트만으로 이미지를 생성합니다.' },
      { q: 'AI 이미지 생성에 크레딧이 얼마나 필요한가요?', a: 'Seedream 4.5는 기본 화질 2크레딧, 고화질 3크레딧입니다. Z-Image는 1크레딧입니다.' },
      { q: '생성된 이미지를 상업적으로 사용할 수 있나요?', a: '네, gwanggo에서 생성된 모든 AI 이미지는 광고 배너, SNS 콘텐츠, 제품 소개 등 상업적 목적으로 자유롭게 사용할 수 있습니다.' },
    ],
    jsonLdDescriptions: {
      webApp: 'Seedream 4.5와 Z-Image를 사용한 AI 이미지 생성 도구. 텍스트/참조 이미지에서 고품질 이미지를 생성합니다.',
  ...
  en: {
    ...
    subtitle: 'Create high-quality images from text or reference images with Seedream 4.5 and Z-Image.',
    breadcrumbHome: 'Home',
    breadcrumbAiTools: 'AI Tools',
    breadcrumbImage: 'Image Generator',
    learnMore: 'Learn more',
    faq: [
      { q: 'What is the difference between Seedream 4.5 and Z-Image?', a: 'Seedream 4.5, developed by ByteDance, is an image editing model that requires a reference image. It supports basic/high quality options and various aspect ratios. Z-Image is a text-to-image model that generates images from prompts alone, without requiring a reference image.' },
      { q: 'How many credits does AI image generation cost?', a: 'Seedream 4.5 costs 2 credits for basic quality and 3 credits for high quality. Z-Image costs 1 credit per image.' },
    ...
    jsonLdDescriptions: {
      webApp: 'AI image generation tool powered by Seedream 4.5 and Z-Image. Create high-quality images from text or reference images.',
  ...
  ja: {
    ...
    h1: 'AI画像生成',
    subtitle: 'Seedream 4.5とZ-Imageでテキストまたは参照画像から高品質な画像を生成します。',
    breadcrumbHome: 'ホーム',
    breadcrumbAiTools: 'AIツール',
    breadcrumbImage: '画像生成',
    learnMore: '詳しく見る',
    faq: [
      { q: 'Seedream 4.5とZ-Imageの違いは何ですか？', a: 'Seedream 4.5はByteDanceが開発した画像編集モデルで、参照画像が必要です。基本/高画質オプションと様々なアスペクト比に対応します。Z-Imageはテキストから画像を生成するモデルで、参照画像なしでプロンプトのみで画像を生成します。' },
      { q: 'AI画像生成にクレジットはいくら必要ですか？', a: 'Seedream 4.5は基本画質2クレジット、高画質3クレジットです。Z-Imageは1クレジットです。' },
      { q: '生成された画像を商用利用できますか？', a: 'はい、gwanggoで生成されたすべてのAI画像は、広告バナー、SNSコンテンツ、商品紹介など商用目的で自由にご利用いただけます。' },
    ],
    jsonLdDescriptions: {
      webApp: 'Seedream 4.5とZ-Imageを使用したAI画像生成ツール。テキスト/参照画像から高品質画像を生成します。',
  ...
  zh: {
    ...
    h1: 'AI图像生成',
    subtitle: '使用Seedream 4.5和Z-Image从文本或参考图像生成高质量图像。',
    breadcrumbHome: '首页',
    breadcrumbAiTools: 'AI工具',
    breadcrumbImage: '图像生成',
    learnMore: '了解更多',
    faq: [
      { q: 'Seedream 4.5和Z-Image有什么区别？', a: 'Seedream 4.5是ByteDance（字节跳动）开发的图像编辑模型，需要参考图像。支持基本/高质量选项和多种比例。Z-Image是文本生成图像模型，无需参考图像，仅通过提示词即可生成图像。' },
      { q: 'AI图像生成需要多少积分？', a: 'Seedream 4.5基本质量2积分，高质量3积分。Z-Image每张1积分。' },
      { q: '生成的图像可以商用吗？', a: '是的，在gwanggo生成的所有AI图像均可自由用于广告横幅、社交媒体内容、产品展示等商业用途。' },
    ],
    jsonLdDescriptions: {
      webApp: '使用Seedream 4.5和Z-Image的AI图像生成工具。从文本/参考图像生成高质量图像。',
