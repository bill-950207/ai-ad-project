...
const i18n: Record<Lang, {
  ...
  ko: {
    ...
    keywords: ['AI 이미지 생성', 'Seedream 5', 'Z-Image', '텍스트 투 이미지', 'AI 이미지 편집', 'AI 그림 생성', '광고 이미지 생성', 'ByteDance', '바이트댄스', 'AI 이미지 메이커', 'Midjourney 대안', 'DALL-E 대안', 'Stable Diffusion 대안', 'GPT Image', 'Flux 대안', 'Ideogram 대안', 'Adobe Firefly 대안', 'Leonardo AI 대안'],
  ...
  en: {
    ...
    keywords: ['AI image generator', 'Seedream 5', 'Z-Image', 'text to image', 'AI image editing', 'AI image maker', 'ad image generation', 'ByteDance', 'AI art generator', 'product image AI', 'Midjourney alternative', 'DALL-E alternative', 'Stable Diffusion alternative', 'GPT Image alternative', 'Flux alternative', 'Ideogram alternative', 'Adobe Firefly alternative', 'Leonardo AI alternative'],
  ...
  ja: {
    ...
    keywords: ['AI画像生成', 'Seedream 5', 'Z-Image', 'テキストから画像', 'AI画像編集', 'AI画像メーカー', '広告画像生成', 'ByteDance', 'バイトダンス', 'AI画像クリエイター', 'Midjourney代替', 'DALL-E代替', 'Stable Diffusion代替', 'GPT Image', 'Flux代替', 'Adobe Firefly代替'],
  ...
  zh: {
    ...
    keywords: ['AI图像生成', 'Seedream 5', 'Z-Image', '文本生成图像', 'AI图像编辑', 'AI图像制作', '广告图像生成', 'ByteDance', '字节跳动', 'AI图片生成器', 'Midjourney替代', 'DALL-E替代', 'Stable Diffusion替代', 'GPT Image', 'Flux替代', 'Adobe Firefly替代'],
