...
const i18n: Record<Lang, {
  ...
  ko: {
    title: 'AI 이미지 생성 - Seedream 5 · FLUX.2 Pro · Nano Banana 2 | gwanggo',
    description: 'Seedream 5, FLUX.2 Pro, Grok Imagine, Nano Banana 2, Z-Image 등 5종 AI 이미지 모델로 고품질 이미지 생성. 이미지 편집, 텍스트 투 이미지, 4K 이미지 지원. 광고 배너, 제품 이미지에 최적화.',
    keywords: ['AI 이미지 생성', 'Seedream 5', 'Z-Image', '텍스트 투 이미지', 'AI 이미지 편집', 'AI 그림 생성', '광고 이미지 생성', 'ByteDance', '바이트댄스', 'AI 이미지 메이커', 'Midjourney 대안', 'DALL-E 대안', 'Stable Diffusion 대안', 'GPT Image', 'Flux 대안', 'Ideogram 대안', 'Adobe Firefly 대안', 'Leonardo AI 대안', 'FLUX.2 Pro', 'FLUX 2 Pro', 'FLUX AI', 'Black Forest Labs', 'Grok Imagine Image', 'xAI', 'Grok AI', 'Grok 이미지', 'Nano Banana 2', 'Google Gemini Image', '4K AI 이미지'],
    ogTitle: 'AI 이미지 생성 - Seedream 5 · FLUX.2 Pro · Nano Banana 2',
    ogDescription: 'Seedream 5, FLUX.2 Pro, Grok Imagine, Nano Banana 2, Z-Image 5종 AI 모델로 텍스트/참조 이미지에서 고품질 이미지를 생성하세요.',
    h1: 'AI 이미지 생성',
    subtitle: '5종 AI 모델로 텍스트 또는 참조 이미지에서 고품질 이미지를 생성하세요.',
    breadcrumbHome: '홈',
    ...
    jsonLdDescriptions: {
      ...
      nanoBanana2: 'Google Gemini 기반 AI 이미지 생성 모델. 1K~4K 고품질 이미지 생성 지원.',
    },
  },
  en: {
    title: 'AI Image Generator - Seedream 5 · FLUX.2 Pro · Nano Banana 2 | gwanggo',
    description: 'Generate AI images with 5 models: Seedream 5, FLUX.2 Pro, Grok Imagine, Nano Banana 2, Z-Image. Image editing, text-to-image, and 4K generation.',
    keywords: ['AI image generator', 'Seedream 5', 'Z-Image', 'text to image', 'AI image editing', 'AI image maker', 'ad image generation', 'ByteDance', 'AI art generator', 'product image AI', 'Midjourney alternative', 'DALL-E alternative', 'Stable Diffusion alternative', 'GPT Image alternative', 'Flux alternative', 'Ideogram alternative', 'Adobe Firefly alternative', 'Leonardo AI alternative', 'FLUX.2 Pro', 'FLUX 2 Pro', 'FLUX AI', 'Black Forest Labs', 'Grok Imagine Image', 'xAI', 'Grok AI', 'Nano Banana 2', 'Google Gemini Image', '4K AI image'],
    ogTitle: 'AI Image Generator - Seedream 5 · FLUX.2 Pro · Nano Banana 2',
    ogDescription: 'Generate high-quality AI images with 5 models including Seedream 5, FLUX.2 Pro, Nano Banana 2, and Grok Imagine.',
    h1: 'AI Image Generator',
    subtitle: 'Create high-quality images from text or reference images with 5 AI models.',
    breadcrumbHome: 'Home',
    ...
    jsonLdDescriptions: {
      ...
      nanoBanana2: 'Google Gemini-based AI image generation model. Supports 1K-4K high-quality image generation.',
    },
  },
  ja: {
    title: 'AI画像生成 - Seedream 5 · FLUX.2 Pro · Nano Banana 2 | gwanggo',
    description: 'Seedream 5、FLUX.2 Pro、Grok Imagine、Nano Banana 2、Z-Imageの5モデルで高品質AI画像を生成。画像編集、テキストから画像、4K生成に対応。',
    keywords: ['AI画像生成', 'Seedream 5', 'Z-Image', 'テキストから画像', 'AI画像編集', 'AI画像メーカー', '広告画像生成', 'ByteDance', 'バイトダンス', 'AI画像クリエイター', 'Midjourney代替', 'DALL-E代替', 'Stable Diffusion代替', 'GPT Image', 'Flux代替', 'Adobe Firefly代替', 'FLUX.2 Pro', 'FLUX 2 Pro', 'FLUX AI', 'Black Forest Labs', 'Grok Imagine Image', 'xAI', 'Grok AI', 'Nano Banana 2', 'Google Gemini Image', '4K AI画像'],
    ogTitle: 'AI画像生成 - Seedream 5 · FLUX.2 Pro · Nano Banana 2',
    ogDescription: 'Seedream 5、FLUX.2 Pro、Grok Imagine、Nano Banana 2、Z-Imageの5モデルでテキスト/参照画像から高品質AI画像を生成。',
    h1: 'AI画像生成',
    subtitle: '5つのAIモデルでテキストまたは参照画像から高品質な画像を生成します。',
    breadcrumbHome: 'ホーム',
    ...
    jsonLdDescriptions: {
      ...
      nanoBanana2: 'Google Geminiベースの AI画像生成モデル。1K〜4K高品質画像生成対応。',
    },
  },
  zh: {
    title: 'AI图像生成 - Seedream 5 · FLUX.2 Pro · Nano Banana 2 | gwanggo',
    description: '支持Seedream 5、FLUX.2 Pro、Grok Imagine、Nano Banana 2、Z-Image等5种AI图像模型。支持图像编辑、文本生成图像和4K生成。',
    keywords: ['AI图像生成', 'Seedream 5', 'Z-Image', '文本生成图像', 'AI图像编辑', 'AI图像制作', '广告图像生成', 'ByteDance', '字节跳动', 'AI图片生成器', 'Midjourney替代', 'DALL-E替代', 'Stable Diffusion替代', 'GPT Image', 'Flux替代', 'Adobe Firefly替代', 'FLUX.2 Pro', 'FLUX 2 Pro', 'FLUX AI', 'Black Forest Labs', 'Grok Imagine Image', 'xAI', 'Grok AI', 'Grok图片', 'Nano Banana 2', 'Google Gemini Image', '4K AI图像'],
    ogTitle: 'AI图像生成 - Seedream 5 · FLUX.2 Pro · Nano Banana 2',
    ogDescription: '使用Seedream 5、FLUX.2 Pro、Grok Imagine、Nano Banana 2、Z-Image等5种AI模型从文本/参考图像生成高质量图像。',
    h1: 'AI图像生成',
    subtitle: '使用5种AI模型从文本或参考图像生成高质量图像。',
    breadcrumbHome: '首页',
    ...
    jsonLdDescriptions: {
      ...
      nanoBanana2: '基于Google Gemini的AI图像生成模型。支持1K~4K高质量图像生成。',
    },
  },
}
  ...
  return {
    tools: [
      ...
      },
      {
        ...
        applicationCategory: 'DesignApplication',
        operatingSystem: 'Web',
        description: data.jsonLdDescriptions.nanoBanana2,
