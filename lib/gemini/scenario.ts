...
const SCENE_SCHEMA = {
  ...
  properties: {
    ...
    motionPromptEN: { type: Type.STRING, description: '모션 설명 (영어, 50-70단어)' },
    duration: { type: Type.NUMBER, description: '씬 길이 (2-5초)' },
    movementAmplitude: {
      type: Type.STRING,
  ...
  properties: {
    ...
    recommendedSettings: {
      ...
      properties: {
        ...
        sceneCount: { type: Type.NUMBER, description: '씬 개수 (3-5)' },
      },
    },
    scenes: {
      type: Type.ARRAY,
      description: '씬 배열 (3-5개)',
      items: SCENE_SCHEMA,
    },
  },
} as const
